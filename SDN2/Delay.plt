...
set key box top right maxcolumns 2
...
plot "Delay.txt" using 1:2:3:4 index 0 with errorlines ls 2 title "Proposed-Scheme", \
     "" using 1:2:3:4 index 1 with errorlines ls 1 title "OneController-Scheme",\
     "" using 1:2:3:4 index 2 with errorlines ls 3 title "Random-Scheme", \
     "" using 1:2:3:4 index 3 with errorlines ls 6 title "Centralized-Scheme"
