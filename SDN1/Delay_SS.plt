...
set ylabel "Average delay (ms)" offset 2


plot 'Delay_SS.txt' using 2:3:4:xtic(1) 	index 0  title "Proposed" 	fs pattern 5 ls 1, \
	 '' using 2:3:4 			index 1  title "Random" 		fs pattern 2 ls 3, \
	 '' using 2:3:4 			index 2  title "Centralized" 		fs pattern 4 ls 6, \
	 '' using 2:3:4 			index 3  title "OneController" 		fs pattern 4 ls 6
